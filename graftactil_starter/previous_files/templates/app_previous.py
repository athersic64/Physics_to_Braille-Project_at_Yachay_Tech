# app.py
# Starter FastAPI + CadQuery + Trimesh project for GrafTactil
# NOTE: CadQuery is recommended to install via conda-forge. See README.md for install steps.
...
async def generate(request: Request):
    ...
    # build functions from strings (careful: eval-like behavior)
    funcs = []
    ...
    # generate preview SVG (2D) for quick view
    ...
    return JSONResponse({"stl": outpath, "preview_svg": preview_svg})
